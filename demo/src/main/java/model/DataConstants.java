...
public abstract class DataConstants {
	...
	protected static final String REQUIREMENT_FILE_NAME = ".demo/main/java/data/requirement.json";
	protected static final String DEGREE_FILE_NAME = ".demo/main/java/data/Degree.json";
